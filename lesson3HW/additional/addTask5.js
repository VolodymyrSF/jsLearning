...
<h3>email: ${usersList[i].email} | phone:${usersList[i].phone}</h3>
<div CLASS="address-block">
<p>${usersList[i].address.city}</p>
<p>${usersList[i].address.street}</p>
<p>${usersList[i].address.suite}</p>
<p>${usersList[i].address.zipcode}</p>
</div>
</div>
    </div>`)
}
